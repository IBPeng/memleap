...
SimulationData binary_read( Inputs in )
{
	...
	gpuErrchk( cudaMallocManaged((void **) &SD.num_nucs, SD.length_num_nucs * sizeof(int) ,cudaMemAttachGlobal));

	//SD.concs = (double *) malloc(SD.length_concs * sizeof(double));
	gpuErrchk( cudaMallocManaged((void **) &SD.concs, SD.length_concs * sizeof(double) ,cudaMemAttachGlobal) );

	//SD.mats = (int *) malloc(SD.length_mats * sizeof(int));
	gpuErrchk( cudaMallocManaged((void **) &SD.mats, SD.length_mats * sizeof(int) ,cudaMemAttachGlobal) );
